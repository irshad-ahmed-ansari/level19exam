...
class DateTimePicker extends ShopUi_models_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  init() {
    ...
    this.dateFrom = document.getElementById(this.dateFromId);
    this.dateTo = document.getElementById(this.dateToId);
    this.mapEvents();
  }
  mapEvents() {
  ...
  setMaxDate() {
    var $dateFrom = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(this.trigger);
    var $dateTo = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(this.dateTo);
    $dateFrom.datetimepicker({
      onShow() {
        ...
        this.setOptions({
          maxDate: $dateTo.datetimepicker('getValue')
        });
      },
      onClose() {
        if (!$dateTo.val()) {
        ...
        var dateFromValue = $dateFrom.datetimepicker('getValue');
        var dateToValue = $dateTo.datetimepicker('getValue');
  ...
  setMinDate() {
    var $dateFrom = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(this.dateFrom);
    var $dateTo = jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_1___default()(this.trigger);
    $dateTo.datetimepicker({
      onShow() {
        if (!$dateFrom.val()) {
          return;
        ...
        this.setOptions({
          minDate: $dateFrom.datetimepicker('getValue')
        });
      },
      onClose() {
        if (!$dateFrom.val()) {
