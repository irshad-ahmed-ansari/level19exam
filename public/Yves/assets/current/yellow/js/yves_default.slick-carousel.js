...
class SlickCarousel extends ShopUi_models_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super(...arguments);
    this.slider = void 0;
  }
  ...
  mapEvents() {
    var _this = this;
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.slider).on('init', /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.showSlider();
  ...
  sliderInit() {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.slider).slick(this.sliderConfig);
  }
  get sliderConfig() {
